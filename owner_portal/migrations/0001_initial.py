    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='owner_portal.area')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='owner_portal.area')),
                ('dealer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='owner_portal.carowner')),
            ],
        ),
    ]
